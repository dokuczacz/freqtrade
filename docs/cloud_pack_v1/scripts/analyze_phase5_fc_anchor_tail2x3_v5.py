...
MANIFEST = Path("user_data/phase5_fc_anchor_tail2x3_v5_manifest.json")
EXECUTION = Path("user_data/backtest_results/phase5_fc_anchor_tail2x3_v5_execution_results.json")
OUT_SUMMARY = Path("user_data/backtest_results/phase5_fc_anchor_tail2x3_v5_summary.json")
OUT_TABLE = Path("user_data/backtest_results/phase5_fc_anchor_tail2x3_v5_table.csv")
OUT_FAILURE_MODES = Path("user_data/backtest_results/phase5_fc_anchor_tail2x3_v5_failure_modes_top3.json")
RESULTS_ROOT = Path("user_data/backtest_results/phase5_fc_anchor_tail2x3_v5")
